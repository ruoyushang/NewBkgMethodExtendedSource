...
Hist2D_Fit_Rank0 = ROOT.TH2D("Hist2D_Fit_Rank0","",N_bins_for_deconv,MSCL_plot_lower,MSCL_plot_upper,N_bins_for_deconv,MSCW_plot_lower,MSCW_plot_upper)
Hist2D_Fit_Rank1 = ROOT.TH2D("Hist2D_Fit_Rank1","",N_bins_for_deconv,MSCL_plot_lower,MSCL_plot_upper,N_bins_for_deconv,MSCW_plot_lower,MSCW_plot_upper)
Hist2D_Fit_Rank2 = ROOT.TH2D("Hist2D_Fit_Rank2","",N_bins_for_deconv,MSCL_plot_lower,MSCL_plot_upper,N_bins_for_deconv,MSCW_plot_lower,MSCW_plot_upper)
Hist2D_Fit_Rank3 = ROOT.TH2D("Hist2D_Fit_Rank3","",N_bins_for_deconv,MSCL_plot_lower,MSCL_plot_upper,N_bins_for_deconv,MSCW_plot_lower,MSCW_plot_upper)
...
Hist_Ring_Theta2 = ROOT.TH1D("Hist_Ring_Theta2","",50,0,10)
...
Hist_Data_Etavalues_real = ROOT.TH1D("Hist_Data_Etavalues_real","",N_bins_for_deconv,0,N_bins_for_deconv)
...
Hist_Data_Eigenvector_0_real = ROOT.TH1D("Hist_Data_Eigenvector_0_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Data_Eigenvector_1_real = ROOT.TH1D("Hist_Data_Eigenvector_1_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Data_Eigenvector_2_real = ROOT.TH1D("Hist_Data_Eigenvector_2_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Data_InvEigenvector_0_real = ROOT.TH1D("Hist_Data_InvEigenvector_0_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Data_InvEigenvector_1_real = ROOT.TH1D("Hist_Data_InvEigenvector_1_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Data_InvEigenvector_2_real = ROOT.TH1D("Hist_Data_InvEigenvector_2_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_Eigenvector_0_real = ROOT.TH1D("Hist_Dark_Eigenvector_0_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_Eigenvector_1_real = ROOT.TH1D("Hist_Dark_Eigenvector_1_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_Eigenvector_2_real = ROOT.TH1D("Hist_Dark_Eigenvector_2_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_InvEigenvector_0_real = ROOT.TH1D("Hist_Dark_InvEigenvector_0_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_InvEigenvector_1_real = ROOT.TH1D("Hist_Dark_InvEigenvector_1_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_InvEigenvector_2_real = ROOT.TH1D("Hist_Dark_InvEigenvector_2_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_Eigenvector_0_real = ROOT.TH1D("Hist_Fit_Eigenvector_0_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_Eigenvector_1_real = ROOT.TH1D("Hist_Fit_Eigenvector_1_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_Eigenvector_2_real = ROOT.TH1D("Hist_Fit_Eigenvector_2_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_InvEigenvector_0_real = ROOT.TH1D("Hist_Fit_InvEigenvector_0_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_InvEigenvector_1_real = ROOT.TH1D("Hist_Fit_InvEigenvector_1_real","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_InvEigenvector_2_real = ROOT.TH1D("Hist_Fit_InvEigenvector_2_real","",N_bins_for_deconv,0,N_bins_for_deconv)
...
Hist2D_Fit_Rank0_SumE = ROOT.TH2D("Hist2D_Fit_Rank0_SumE","",N_bins_for_deconv,MSCL_plot_lower,MSCL_plot_upper,N_bins_for_deconv,MSCW_plot_lower,MSCW_plot_upper)
Hist2D_Fit_Rank1_SumE = ROOT.TH2D("Hist2D_Fit_Rank1_SumE","",N_bins_for_deconv,MSCL_plot_lower,MSCL_plot_upper,N_bins_for_deconv,MSCW_plot_lower,MSCW_plot_upper)
Hist2D_Fit_Rank2_SumE = ROOT.TH2D("Hist2D_Fit_Rank2_SumE","",N_bins_for_deconv,MSCL_plot_lower,MSCL_plot_upper,N_bins_for_deconv,MSCW_plot_lower,MSCW_plot_upper)
Hist2D_Fit_Rank3_SumE = ROOT.TH2D("Hist2D_Fit_Rank3_SumE","",N_bins_for_deconv,MSCL_plot_lower,MSCL_plot_upper,N_bins_for_deconv,MSCW_plot_lower,MSCW_plot_upper)
...
Hist_Ring_Theta2_SumE = ROOT.TH1D("Hist_Ring_Theta2_SumE","",50,0,10)
...
Hist_Data_Etavalues_real_SumE = ROOT.TH1D("Hist_Data_Etavalues_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
...
Hist_Data_Eigenvector_0_real_SumE = ROOT.TH1D("Hist_Data_Eigenvector_0_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Data_Eigenvector_1_real_SumE = ROOT.TH1D("Hist_Data_Eigenvector_1_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Data_Eigenvector_2_real_SumE = ROOT.TH1D("Hist_Data_Eigenvector_2_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Data_InvEigenvector_0_real_SumE = ROOT.TH1D("Hist_Data_InvEigenvector_0_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Data_InvEigenvector_1_real_SumE = ROOT.TH1D("Hist_Data_InvEigenvector_1_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Data_InvEigenvector_2_real_SumE = ROOT.TH1D("Hist_Data_InvEigenvector_2_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_Eigenvector_0_real_SumE = ROOT.TH1D("Hist_Dark_Eigenvector_0_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_Eigenvector_1_real_SumE = ROOT.TH1D("Hist_Dark_Eigenvector_1_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_Eigenvector_2_real_SumE = ROOT.TH1D("Hist_Dark_Eigenvector_2_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_InvEigenvector_0_real_SumE = ROOT.TH1D("Hist_Dark_InvEigenvector_0_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_InvEigenvector_1_real_SumE = ROOT.TH1D("Hist_Dark_InvEigenvector_1_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Dark_InvEigenvector_2_real_SumE = ROOT.TH1D("Hist_Dark_InvEigenvector_2_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_Eigenvector_0_real_SumE = ROOT.TH1D("Hist_Fit_Eigenvector_0_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_Eigenvector_1_real_SumE = ROOT.TH1D("Hist_Fit_Eigenvector_1_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_Eigenvector_2_real_SumE = ROOT.TH1D("Hist_Fit_Eigenvector_2_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_InvEigenvector_0_real_SumE = ROOT.TH1D("Hist_Fit_InvEigenvector_0_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_InvEigenvector_1_real_SumE = ROOT.TH1D("Hist_Fit_InvEigenvector_1_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
Hist_Fit_InvEigenvector_2_real_SumE = ROOT.TH1D("Hist_Fit_InvEigenvector_2_real_SumE","",N_bins_for_deconv,0,N_bins_for_deconv)
...
Hist_Data_RoI_1_Energy = ROOT.TH1D("Hist_Data_RoI_1_Energy","",len(energy_fine_bin)-1,array('d',energy_fine_bin))
Hist_Bkgd_RoI_1_Energy = ROOT.TH1D("Hist_Bkgd_RoI_1_Energy","",len(energy_fine_bin)-1,array('d',energy_fine_bin))
Hist_Data_RoI_2_Energy = ROOT.TH1D("Hist_Data_RoI_2_Energy","",len(energy_fine_bin)-1,array('d',energy_fine_bin))
Hist_Bkgd_RoI_2_Energy = ROOT.TH1D("Hist_Bkgd_RoI_2_Energy","",len(energy_fine_bin)-1,array('d',energy_fine_bin))
...
Hist_Data_RoI_1_Energy_SumE = ROOT.TH1D("Hist_Data_RoI_1_Energy_SumE","",len(energy_fine_bin)-1,array('d',energy_fine_bin))
Hist_Bkgd_RoI_1_Energy_SumE = ROOT.TH1D("Hist_Bkgd_RoI_1_Energy_SumE","",len(energy_fine_bin)-1,array('d',energy_fine_bin))
Hist_Data_RoI_2_Energy_SumE = ROOT.TH1D("Hist_Data_RoI_2_Energy_SumE","",len(energy_fine_bin)-1,array('d',energy_fine_bin))
Hist_Bkgd_RoI_2_Energy_SumE = ROOT.TH1D("Hist_Bkgd_RoI_2_Energy_SumE","",len(energy_fine_bin)-1,array('d',energy_fine_bin))
...
def MakeSpectrumInCrabUnit(Hists,title,name,syst):
    ...
    for binx in range(0,Hist_Syst.GetNbinsX()):
        if 'Ring' in name:
            syst = 0.02
            if len(Syst_MDM_Energy)>0: syst = Syst_Ring_Energy[binx]
            Hist_Syst.SetBinContent(binx+1,Hists[1].GetBinContent(binx+1)*5.*syst)
        else:
            syst = 0.02
            if len(Syst_MDM_Energy)>0: syst = Syst_MDM_Energy[binx]
            Hist_Syst.SetBinContent(binx+1,Hists[1].GetBinContent(binx+1)*5.*syst)
    ...
    for binx in range(0,Hist_MDM.GetNbinsX()):
        ...
        if len(Hists)>3:
            for hist in range(3,len(Hists)):
                Hists[hist].SetBinContent(binx+1,Hists[hist].GetBinContent(binx+1)*scale)
                Hists[hist].SetBinError(binx+1,Hists[hist].GetBinError(binx+1)*scale)
    ...
    if len(Hists)>3:
        for hist in range(3,len(Hists)):
            Hists[hist].SetLineColor(hist)
            Hists[hist].Draw("E same")
...
def Make2DSignificancePlot(syst_method,Hist_SR,Hist_Bkg,Hist_SR_smooth,Hist_Bkg_smooth,Hist_Sig_zoomin,Hist_Highlight,Hist_Highlight_bias,Hist_Highlight_zoomin,xtitle,ytitle,name):
    ...
    for star in range(0,len(other_star_markers)):
        #other_star_markers[star].SetMarkerColor(2)
        other_star_markers[star].Draw("same")
        #other_star_labels[star].SetTextColor(2)
...
def Make2DSignificancePlotShowerShape(Hist_SR,Hist_CR,Hist_gamma,xtitle,ytitle,name):
    ...
    Hist_gamma.GetYaxis().SetTitle(ytitle)
    Hist_gamma.GetXaxis().SetTitle(xtitle)
    Hist_gamma.Draw("COL4Z")
    line1 = ROOT.TLine(MSCL_lower_cut,MSCW_blind_cut,MSCL_blind_cut,MSCW_blind_cut)
    line1.SetLineStyle(1)
    line1.SetLineColor(2)
    line1.SetLineWidth(2)
    ...
    line2.SetLineWidth(2)
    line2.Draw()
    canvas.SaveAs('output_plots/ShowerShapeGamma_%s.png'%(name))
...
def ResetStackedRingHistograms():

    Hist_Data_Skymap2_SumE.Reset()
    Hist_Ring_Skymap_SumE.Reset()
...
def ResetStackedShowerHistograms():
    ...
    Hist2D_Fit_Rank0_SumE.Reset()
    Hist2D_Fit_Rank1_SumE.Reset()
    Hist2D_Fit_Rank2_SumE.Reset()
    Hist2D_Fit_Rank3_SumE.Reset()
    ...
    Hist_Data_RoI_1_Energy_SumE.Reset()
    Hist_Bkgd_RoI_1_Energy_SumE.Reset()
    Hist_Data_RoI_2_Energy_SumE.Reset()
    Hist_Bkgd_RoI_2_Energy_SumE.Reset()
    ...
    Hist_Data_Etavalues_real_SumE.Reset()
    ...
    Hist_Data_InvEigenvector_0_real_SumE.Reset()
    Hist_Data_InvEigenvector_1_real_SumE.Reset()
    Hist_Data_InvEigenvector_2_real_SumE.Reset()
    Hist_Dark_Eigenvector_0_real_SumE.Reset()
    Hist_Dark_Eigenvector_1_real_SumE.Reset()
    Hist_Dark_Eigenvector_2_real_SumE.Reset()
    Hist_Dark_InvEigenvector_0_real_SumE.Reset()
    Hist_Dark_InvEigenvector_1_real_SumE.Reset()
    Hist_Dark_InvEigenvector_2_real_SumE.Reset()
    Hist_Fit_Eigenvector_0_real_SumE.Reset()
    Hist_Fit_Eigenvector_1_real_SumE.Reset()
    Hist_Fit_Eigenvector_2_real_SumE.Reset()
    Hist_Fit_InvEigenvector_0_real_SumE.Reset()
    Hist_Fit_InvEigenvector_1_real_SumE.Reset()
    Hist_Fit_InvEigenvector_2_real_SumE.Reset()

def StackRingHistograms():

    Hist_Data_Skymap2_SumE.Add(Hist_Data_Skymap2)
    Hist_Ring_Skymap_SumE.Add(Hist_Ring_Skymap)

def StackShowerHistograms():

    Hist_Ring_Theta2_SumE.Add(Hist_Ring_Theta2)
    ...
    Hist2D_Fit_Rank0_SumE.Add(Hist2D_Fit_Rank0)
    Hist2D_Fit_Rank1_SumE.Add(Hist2D_Fit_Rank1)
    Hist2D_Fit_Rank2_SumE.Add(Hist2D_Fit_Rank2)
    Hist2D_Fit_Rank3_SumE.Add(Hist2D_Fit_Rank3)
    ...
    Hist_Data_Etavalues_real_SumE.Add(Hist_Data_Etavalues_real)
    ...
    #Hist_Data_InvEigenvector_0_real.Scale(1./Hist_Data_InvEigenvector_0_real.Integral())
    #Hist_Data_InvEigenvector_1_real.Scale(1./Hist_Data_InvEigenvector_1_real.Integral())
    #Hist_Data_InvEigenvector_2_real.Scale(1./Hist_Data_InvEigenvector_2_real.Integral())
    Hist_Data_InvEigenvector_0_real_SumE.Add(Hist_Data_InvEigenvector_0_real)
    Hist_Data_InvEigenvector_1_real_SumE.Add(Hist_Data_InvEigenvector_1_real)
    Hist_Data_InvEigenvector_2_real_SumE.Add(Hist_Data_InvEigenvector_2_real)
    ...
    #Hist_Dark_InvEigenvector_0_real.Scale(1./Hist_Dark_InvEigenvector_0_real.Integral())
    #Hist_Dark_InvEigenvector_1_real.Scale(1./Hist_Dark_InvEigenvector_1_real.Integral())
    #Hist_Dark_InvEigenvector_2_real.Scale(1./Hist_Dark_InvEigenvector_2_real.Integral())
    Hist_Dark_InvEigenvector_0_real_SumE.Add(Hist_Dark_InvEigenvector_0_real)
    Hist_Dark_InvEigenvector_1_real_SumE.Add(Hist_Dark_InvEigenvector_1_real)
    Hist_Dark_InvEigenvector_2_real_SumE.Add(Hist_Dark_InvEigenvector_2_real)
    ...
    #Hist_Fit_InvEigenvector_0_real.Scale(1./Hist_Fit_InvEigenvector_0_real.Integral())
    #Hist_Fit_InvEigenvector_1_real.Scale(1./Hist_Fit_InvEigenvector_1_real.Integral())
    #Hist_Fit_InvEigenvector_2_real.Scale(1./Hist_Fit_InvEigenvector_2_real.Integral())
    Hist_Fit_InvEigenvector_0_real_SumE.Add(Hist_Fit_InvEigenvector_0_real)
    Hist_Fit_InvEigenvector_1_real_SumE.Add(Hist_Fit_InvEigenvector_1_real)
    Hist_Fit_InvEigenvector_2_real_SumE.Add(Hist_Fit_InvEigenvector_2_real)
...
def StackEnergyHistograms():
    ...
    Hist_Data_RoI_1_Energy_SumE.Add(Hist_Data_RoI_1_Energy)
    Hist_Bkgd_RoI_1_Energy_SumE.Add(Hist_Bkgd_RoI_1_Energy)
    Hist_Data_RoI_2_Energy_SumE.Add(Hist_Data_RoI_2_Energy)
    Hist_Bkgd_RoI_2_Energy_SumE.Add(Hist_Bkgd_RoI_2_Energy)
...
def NormalizeEnergyHistograms(FilePath):
    ...
    HistName = "Hist_Data_SR_RoI_1_Energy_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist_Data_RoI_1_Energy.Reset()
    Hist_Data_RoI_1_Energy.Add(InputFile.Get(HistName))
    HistName = "Hist_Data_CR_RoI_1_Energy_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist_Bkgd_RoI_1_Energy.Reset()
    Hist_Bkgd_RoI_1_Energy.Add(InputFile.Get(HistName))
    HistName = "Hist_Data_SR_RoI_2_Energy_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist_Data_RoI_2_Energy.Reset()
    Hist_Data_RoI_2_Energy.Add(InputFile.Get(HistName))
    HistName = "Hist_Data_CR_RoI_2_Energy_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist_Bkgd_RoI_2_Energy.Reset()
    Hist_Bkgd_RoI_2_Energy.Add(InputFile.Get(HistName))
    ...
    if not bkg_total==0:
        ...
        Theta2HistScale(Hist_Bkgd_RoI_1_Energy,bkgd_scale,bkgd_scale_err)
        Theta2HistScale(Hist_Bkgd_RoI_2_Energy,bkgd_scale,bkgd_scale_err)
        ...
        Hist_Bkgd_RoI_1_Energy.Scale(0)
        Hist_Bkgd_RoI_2_Energy.Scale(0)
...
def NormalizeEigenvalues():
    ...
    Hist2D_Fit_Rank0_SumE.Scale(1./Hist_Data_Eigenvalues_real_SumE.GetBinContent(1))
    Hist2D_Fit_Rank1_SumE.Scale(1./Hist_Data_Eigenvalues_real_SumE.GetBinContent(2))
    Hist2D_Fit_Rank2_SumE.Scale(1./Hist_Data_Eigenvalues_real_SumE.GetBinContent(3))
    Hist2D_Fit_Rank3_SumE.Scale(1./Hist_Data_Eigenvalues_real_SumE.GetBinContent(4))
...
def GetRingHistogramsFromFile(FilePath):
    ...
    HistName = "Hist_Data_SR_Skymap2_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist_Data_Skymap2.Reset()
    Hist_Data_Skymap2.Add(InputFile.Get(HistName))
    HistName = "Hist_Data_RingOFF_Skymap2_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
...
def GetShowerHistogramsFromFile(FilePath):
    ...
    HistName = "Hist_Data_RingOFF_Skymap2_Theta2_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist_Ring_Theta2.Reset()
    ...
    #HistName = "Hist_Spectral_Rank0_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist2D_Rank0.Reset()
    Hist2D_Rank0.Add(InputFile.Get(HistName))
    HistName = "Hist_Rank1_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    #HistName = "Hist_Spectral_Rank1_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist2D_Rank1.Reset()
    Hist2D_Rank1.Add(InputFile.Get(HistName))
    HistName = "Hist_Rank2_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    #HistName = "Hist_Spectral_Rank2_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist2D_Rank2.Reset()
    Hist2D_Rank2.Add(InputFile.Get(HistName))
    HistName = "Hist_Rank3_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    #HistName = "Hist_Spectral_Rank3_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist2D_Rank3.Reset()
    Hist2D_Rank3.Add(InputFile.Get(HistName))
    HistName = "Hist_Bkgd_Rank0_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist2D_Fit_Rank0.Reset()
    Hist2D_Fit_Rank0.Add(InputFile.Get(HistName))
    HistName = "Hist_Bkgd_Rank1_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist2D_Fit_Rank1.Reset()
    Hist2D_Fit_Rank1.Add(InputFile.Get(HistName))
    HistName = "Hist_Bkgd_Rank2_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist2D_Fit_Rank2.Reset()
    Hist2D_Fit_Rank2.Add(InputFile.Get(HistName))
    HistName = "Hist_Bkgd_Rank3_MSCLW_ErecS%sto%s"%(ErecS_lower_cut_int,ErecS_upper_cut_int)
    Hist2D_Fit_Rank3.Reset()
    Hist2D_Fit_Rank3.Add(InputFile.Get(HistName))
    ...
    HistName = "Hist_Data_Etavalues_real_ErecS%sto%s"%(ErecS_lower_cut,ErecS_upper_cut)
    Hist_Data_Etavalues_real.Reset()
    Hist_Data_Etavalues_real.Add(InputFile.Get(HistName))
    ...
    Hist_Data_InvEigenvector_0_real.Reset()
    Hist_Data_InvEigenvector_0_real.Add(InputFile.Get(HistName))
    HistName = "Hist_Data_InvEigenvectorReal_1_ErecS%sto%s"%(ErecS_lower_cut,ErecS_upper_cut)
    Hist_Data_InvEigenvector_1_real.Reset()
    Hist_Data_InvEigenvector_1_real.Add(InputFile.Get(HistName))
    HistName = "Hist_Data_InvEigenvectorReal_2_ErecS%sto%s"%(ErecS_lower_cut,ErecS_upper_cut)
    Hist_Data_InvEigenvector_2_real.Reset()
    Hist_Data_InvEigenvector_2_real.Add(InputFile.Get(HistName))
    ...
    Hist_Dark_InvEigenvector_0_real.Reset()
    Hist_Dark_InvEigenvector_0_real.Add(InputFile.Get(HistName))
    HistName = "Hist_Dark_InvEigenvectorReal_1_ErecS%sto%s"%(ErecS_lower_cut,ErecS_upper_cut)
    Hist_Dark_InvEigenvector_1_real.Reset()
    Hist_Dark_InvEigenvector_1_real.Add(InputFile.Get(HistName))
    HistName = "Hist_Dark_InvEigenvectorReal_2_ErecS%sto%s"%(ErecS_lower_cut,ErecS_upper_cut)
    Hist_Dark_InvEigenvector_2_real.Reset()
    Hist_Dark_InvEigenvector_2_real.Add(InputFile.Get(HistName))
    ...
    Hist_Fit_InvEigenvector_0_real.Reset()
    Hist_Fit_InvEigenvector_0_real.Add(InputFile.Get(HistName))
    HistName = "Hist_Fit_InvEigenvectorReal_1_ErecS%sto%s"%(ErecS_lower_cut,ErecS_upper_cut)
    Hist_Fit_InvEigenvector_1_real.Reset()
    Hist_Fit_InvEigenvector_1_real.Add(InputFile.Get(HistName))
    HistName = "Hist_Fit_InvEigenvectorReal_2_ErecS%sto%s"%(ErecS_lower_cut,ErecS_upper_cut)
    Hist_Fit_InvEigenvector_2_real.Reset()
    Hist_Fit_InvEigenvector_2_real.Add(InputFile.Get(HistName))
...
def PlotsStackedHistograms(tag):
    ...
    legends += ['true bkg.']
    colors += [2]
    Hists += [Hist_Ring_Theta2_SumE]
    legends += ['predict. bkg.']
    colors += [4]
    plotname = 'Stack_theta2_Ring_%s'%(tag)
    title = 'squared angle from source location #theta^{2}'
    MakeChi2Plot(Hists,legends,colors,title,plotname,True,False,0.,theta2_threshold,-1)
    ...
    Hist_Data_RoI_1_Energy_SumE.Add(Hist_Bkgd_RoI_1_Energy_SumE,-1.)
    Hists += [Hist_Data_RoI_1_Energy_SumE]
    legends += ['RoI 1']
    colors += [3]
    Hist_Data_RoI_2_Energy_SumE.Add(Hist_Bkgd_RoI_2_Energy_SumE,-1.)
    Hists += [Hist_Data_RoI_2_Energy_SumE]
    legends += ['RoI 2']
    colors += [4]
    MakeSpectrumInCrabUnit(Hists,title,plotname,-1)
...
def SystAsFunctionOfSignal():
    ...
    for flux in range(0,len(SignalFlux)):
        ...
        Hist_Eigenvector_0 += [ROOT.TH1D("Hist_Eigenvector_0_%s"%(flux),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_1 += [ROOT.TH1D("Hist_Eigenvector_1_%s"%(flux),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_2 += [ROOT.TH1D("Hist_Eigenvector_2_%s"%(flux),"",N_bins_for_deconv,0,N_bins_for_deconv)]
...
def SystAsFunctionOfElevation():
    ...
    for elev in range(0,len(elev_range)):
        ...
        Hist_Eigenvector_0 += [ROOT.TH1D("Hist_Eigenvector_0_%s"%(elev),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_1 += [ROOT.TH1D("Hist_Eigenvector_1_%s"%(elev),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_2 += [ROOT.TH1D("Hist_Eigenvector_2_%s"%(elev),"",N_bins_for_deconv,0,N_bins_for_deconv)]
...
def SystAsFunctionOfRank():
    ...
    for source in range(0,len(FilePath_Folder0)):
        ...
        for rank in range(0,8):
            ...
            Hist_Ratio_Rank[len(Hist_Ratio_Rank)-1].SetBinContent(rank+1,abs(1.-bkgd_integral/data_integral))
    ...
    MakeComparisonPlot(Hist_Ratio_Rank,legend_S2B,color_S2B,'n ranks','Residual in gamma region','Residual_Rank%s_%s'%(PercentCrab,folder_tag),0.,0.,False,True)
    ...
    for source in range(0,len(FilePath_Folder0)):
        ...
        Hist_Residual_Rank += [ROOT.TH1D("Hist_Residual_Rank_%s"%(source_name),"",4,0,4)]
        legend_S2B += ['%s (%0.1f hrs)'%(source_name,exposure_hours)]
        color_idx = int(source*len(color_code)/max(1,len(FilePath_Folder0)-1))
        color_idx = min(color_idx,len(color_code)-1)
        color_S2B += [color_code[color_idx]]
        ...
        Hist_Residual_Rank[len(Hist_Residual_Rank)-1].SetBinContent(1,abs(1.-bkgd_rank0_integral/data_integral))
        ratio_err = bkgd_rank0_integral/data_integral*1./pow(data_integral,0.5)
        Hist_Residual_Rank[len(Hist_Residual_Rank)-1].SetBinError(1,ratio_err)
        Hist_Residual_Rank[len(Hist_Residual_Rank)-1].SetBinContent(2,abs(1.-(bkgd_rank0_integral+bkgd_rank1_integral)/data_integral))
        ratio_err = (bkgd_rank0_integral+bkgd_rank1_integral)/data_integral*1./pow(data_integral,0.5)
        Hist_Residual_Rank[len(Hist_Residual_Rank)-1].SetBinError(2,ratio_err)
        Hist_Residual_Rank[len(Hist_Residual_Rank)-1].SetBinContent(3,abs(1.-(bkgd_rank0_integral+bkgd_rank1_integral+bkgd_rank2_integral)/data_integral))
        ratio_err = (bkgd_rank0_integral+bkgd_rank1_integral+bkgd_rank2_integral)/data_integral*1./pow(data_integral,0.5)
        Hist_Residual_Rank[len(Hist_Residual_Rank)-1].SetBinError(3,ratio_err)
        Hist_Residual_Rank[len(Hist_Residual_Rank)-1].SetBinContent(4,abs(1.-(bkgd_rank0_integral+bkgd_rank1_integral+bkgd_rank2_integral+bkgd_rank3_integral)/data_integral))
        ...
        Hist_Residual_Rank[len(Hist_Residual_Rank)-1].SetBinError(4,ratio_err)
    ...
    MakeComparisonPlot(Hist_Residual_Rank,legend_S2B,color_S2B,'n ranks','Residual in gamma region','Residual2_Rank%s_%s'%(PercentCrab,folder_tag),0.,0.,False,True)
...
def SystDarkVsMDM():
    ...
    Hist_Avg_Eigenvector_0 = ROOT.TH1D("Hist_Avg_Eigenvector_0","",N_bins_for_deconv,0,N_bins_for_deconv)
    Hist_Avg_Eigenvector_1 = ROOT.TH1D("Hist_Avg_Eigenvector_1","",N_bins_for_deconv,0,N_bins_for_deconv)
    Hist_Avg_Eigenvector_2 = ROOT.TH1D("Hist_Avg_Eigenvector_2","",N_bins_for_deconv,0,N_bins_for_deconv)
    norm_avg_inv_eigenvector_0 = 0.
    norm_avg_inv_eigenvector_1 = 0.
    norm_avg_inv_eigenvector_2 = 0.
    Hist_Avg_InvEigenvector_0 = ROOT.TH1D("Hist_Avg_InvEigenvector_0","",N_bins_for_deconv,0,N_bins_for_deconv)
    Hist_Avg_InvEigenvector_1 = ROOT.TH1D("Hist_Avg_InvEigenvector_1","",N_bins_for_deconv,0,N_bins_for_deconv)
    Hist_Avg_InvEigenvector_2 = ROOT.TH1D("Hist_Avg_InvEigenvector_2","",N_bins_for_deconv,0,N_bins_for_deconv)
    for source in range(0,len(FilePath_Folder0)):
        source_name = FilePath_Folder0[source][0]
        exposure_hours = 0.
        exposure_hours_dark = 0.
        ...
        Hist_S2B_Ring += [ROOT.TH1D("Hist_S2B_Ring_%s"%(source_name),"",2,0,2)]
        Hist_S2B_Ring[len(Hist_S2B_Ring)-1].GetXaxis().SetBinLabel(1,'RBM')
        Hist_S2B_Ring[len(Hist_S2B_Ring)-1].GetXaxis().SetBinLabel(2,'MDM')
        Hist_Etavalue_real_Rank += [ROOT.TH1D("Hist_Etavalue_real_Rank_%s"%(source_name),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        ...
        Hist_Eigenvector_0 += [ROOT.TH1D("Hist_Eigenvector_0_%s"%(source_name),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_1 += [ROOT.TH1D("Hist_Eigenvector_1_%s"%(source_name),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_2 += [ROOT.TH1D("Hist_Eigenvector_2_%s"%(source_name),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_0 += [ROOT.TH1D("Hist_InvEigenvector_0_%s"%(source_name),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_1 += [ROOT.TH1D("Hist_InvEigenvector_1_%s"%(source_name),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_2 += [ROOT.TH1D("Hist_InvEigenvector_2_%s"%(source_name),"",N_bins_for_deconv,0,N_bins_for_deconv)]
        ...
        NormalizeEigenvalues()
        Hist_Etavalue_real_Rank[len(Hist_Etavalue_real_Rank)-1].Add(Hist_Data_Etavalues_real_SumE)
        Hist_Eigenvalue_real_Rank[len(Hist_Eigenvalue_real_Rank)-1].Add(Hist_Data_Eigenvalues_real_SumE)
        for binx in range(0,Hist_Data_Eigenvalues_real_SumE.GetNbinsX()):
        ...
        Hist_S2B_Ring[len(Hist_S2B_Ring)-1].SetBinContent(2,s2b)
        Hist_S2B_Ring[len(Hist_S2B_Ring)-1].SetBinError(2,s2b_err)
        ...
        s2b_err = 0.
        if not "_Crab0" in PercentCrab:
            s2b, s2b_err = Variation_ratio(Hist_TrueBkgd_Theta2_SumE,Hist_Ring_Theta2_SumE,0.2,1.0)
        else:
            s2b, s2b_err = Variation_ratio(Hist_Data_Theta2_SumE,Hist_Ring_Theta2_SumE,0.2,1.0)
        Hist_S2B_Ring[len(Hist_S2B_Ring)-1].SetBinContent(1,s2b)
        Hist_S2B_Ring[len(Hist_S2B_Ring)-1].SetBinError(1,s2b_err)
    ...
    Syst_Ring, Syst_MDM = MakeComparisonPlotTwoColumn(Hist_S2B_Ring,legend_S2B,color_S2B,'methods','Systematics_RBMVsMDM%s_%s'%(PercentCrab,folder_tag),0.6,1.4,False,False)

    for hist in range(0,len(Hist_Eigenvalue_real_Rank)):
        Hist_Etavalue_real_Rank[hist].GetXaxis().SetRangeUser(0,16)
        Hist_Eigenvalue_ampl_Rank[hist].GetXaxis().SetRangeUser(0,16)
        Hist_Eigenvalue_real_Rank[hist].GetXaxis().SetRangeUser(0,16)
        Hist_Eigenvalue_real_Sigma[hist].GetXaxis().SetRangeUser(0,16)
    MakeComparisonPlot(Hist_Etavalue_real_Rank,legend_S2B_hours,color_S2B,'k','#eta_{k}','Etavalue_ampl_Rank%s_%s'%(PercentCrab,folder_tag),0.,0.,False,False)
...
def SingleSourceSkyMap(source_name_input,doMap):
    ...
    Hist_Fit_CountGamma_Rank = []
    Hist_Fit_CountHadron1_Rank = []
    Hist_Fit_CountHadron2_Rank = []
    Hist_Fit_CountHadron3_Rank = []
    Hist_Eigenvalues = []
    Hist_Eigenvector_0 = []
    Hist_Eigenvector_1 = []
    Hist_InvEigenvector_0 = []
    ...
    legend_S2B = []
    color_S2B = []
    bin_lower_x = Hist2D_Data.GetXaxis().FindBin(0.5)
    bin_upper_x = Hist2D_Data.GetXaxis().FindBin(0.5)-1
    bin_lower_y = Hist2D_Data.GetYaxis().FindBin(0.5)
    bin_upper_y = Hist2D_Data.GetYaxis().FindBin(0.5)-1
    for source in range(0,len(source_list)):
        if not source_name_input==source_list[source]: continue
        source_name = source_list[source]
        for flux in range(0,len(SignalFlux)):
            Hist_ResidualGamma_Rank += [ROOT.TH1D("Hist_ResidualGamma_Rank_%s"%(flux),"",4,0,4)]
            ...
            Hist_Fit_CountGamma_Rank += [ROOT.TH1D("Hist_Fit_CountGamma_Rank_%s"%(flux),"",4,0,4)]
            Hist_Fit_CountHadron1_Rank += [ROOT.TH1D("Hist_Fit_CountHadron1_Rank_%s"%(flux),"",4,0,4)]
            Hist_Fit_CountHadron2_Rank += [ROOT.TH1D("Hist_Fit_CountHadron2_Rank_%s"%(flux),"",4,0,4)]
            Hist_Fit_CountHadron3_Rank += [ROOT.TH1D("Hist_Fit_CountHadron3_Rank_%s"%(flux),"",4,0,4)]
            Hist_Eigenvalues += [ROOT.TH1D("Hist_Eigenvalues_%s"%(flux),"",N_bins_for_deconv,0,N_bins_for_deconv)]
            Hist_Eigenvector_0 += [ROOT.TH1D("Hist_Eigenvector_0_%s"%(flux),"",N_bins_for_deconv,0,N_bins_for_deconv)]
            Hist_Eigenvector_1 += [ROOT.TH1D("Hist_Eigenvector_1_%s"%(flux),"",N_bins_for_deconv,0,N_bins_for_deconv)]
            Hist_InvEigenvector_0 += [ROOT.TH1D("Hist_InvEigenvector_0_%s"%(flux),"",N_bins_for_deconv,0,N_bins_for_deconv)]
            Hist_InvEigenvector_1 += [ROOT.TH1D("Hist_InvEigenvector_1_%s"%(flux),"",N_bins_for_deconv,0,N_bins_for_deconv)]
            ...
            if data_gamma_integral==0.: continue
            #data_gamma_integral = 1.
            #data_hadron1_integral = 1.
            #data_hadron2_integral = 1.
            #data_hadron3_integral = 1.
            data_rank0_gamma_integral = Hist2D_Rank0_SumE.Integral(bin_lower_x,bin_upper_x,bin_lower_y,bin_upper_y)
            data_rank1_gamma_integral = Hist2D_Rank1_SumE.Integral(bin_lower_x,bin_upper_x,bin_lower_y,bin_upper_y)
            data_rank2_gamma_integral = Hist2D_Rank2_SumE.Integral(bin_lower_x,bin_upper_x,bin_lower_y,bin_upper_y)
            data_rank3_gamma_integral = Hist2D_Rank3_SumE.Integral(bin_lower_x,bin_upper_x,bin_lower_y,bin_upper_y)
            fit_rank0_gamma_integral = Hist2D_Fit_Rank0_SumE.Integral(bin_lower_x,bin_upper_x,bin_lower_y,bin_upper_y)
            fit_rank1_gamma_integral = Hist2D_Fit_Rank1_SumE.Integral(bin_lower_x,bin_upper_x,bin_lower_y,bin_upper_y)
            fit_rank2_gamma_integral = Hist2D_Fit_Rank2_SumE.Integral(bin_lower_x,bin_upper_x,bin_lower_y,bin_upper_y)
            fit_rank3_gamma_integral = Hist2D_Fit_Rank3_SumE.Integral(bin_lower_x,bin_upper_x,bin_lower_y,bin_upper_y)
            data_rank0_hadron3_integral = Hist2D_Rank0_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            data_rank1_hadron3_integral = Hist2D_Rank1_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            data_rank2_hadron3_integral = Hist2D_Rank2_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            data_rank3_hadron3_integral = Hist2D_Rank3_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            fit_rank0_hadron3_integral = Hist2D_Fit_Rank0_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            fit_rank1_hadron3_integral = Hist2D_Fit_Rank1_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            fit_rank2_hadron3_integral = Hist2D_Fit_Rank2_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            fit_rank3_hadron3_integral = Hist2D_Fit_Rank3_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            data_rank0_hadron1_integral = Hist2D_Rank0_SumE.Integral(bin_lower_x,bin_upper_x,bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            data_rank1_hadron1_integral = Hist2D_Rank1_SumE.Integral(bin_lower_x,bin_upper_x,bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            data_rank2_hadron1_integral = Hist2D_Rank2_SumE.Integral(bin_lower_x,bin_upper_x,bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            data_rank3_hadron1_integral = Hist2D_Rank3_SumE.Integral(bin_lower_x,bin_upper_x,bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            fit_rank0_hadron1_integral = Hist2D_Fit_Rank0_SumE.Integral(bin_lower_x,bin_upper_x,bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            fit_rank1_hadron1_integral = Hist2D_Fit_Rank1_SumE.Integral(bin_lower_x,bin_upper_x,bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            fit_rank2_hadron1_integral = Hist2D_Fit_Rank2_SumE.Integral(bin_lower_x,bin_upper_x,bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            fit_rank3_hadron1_integral = Hist2D_Fit_Rank3_SumE.Integral(bin_lower_x,bin_upper_x,bin_upper_y,Hist2D_Rank0_SumE.GetNbinsY())
            data_rank0_hadron2_integral = Hist2D_Rank0_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_lower_y,bin_upper_y)
            data_rank1_hadron2_integral = Hist2D_Rank1_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_lower_y,bin_upper_y)
            data_rank2_hadron2_integral = Hist2D_Rank2_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_lower_y,bin_upper_y)
            data_rank3_hadron2_integral = Hist2D_Rank3_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_lower_y,bin_upper_y)
            fit_rank0_hadron2_integral = Hist2D_Fit_Rank0_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_lower_y,bin_upper_y)
            fit_rank1_hadron2_integral = Hist2D_Fit_Rank1_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_lower_y,bin_upper_y)
            fit_rank2_hadron2_integral = Hist2D_Fit_Rank2_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_lower_y,bin_upper_y)
            fit_rank3_hadron2_integral = Hist2D_Fit_Rank3_SumE.Integral(bin_upper_x,Hist2D_Rank0_SumE.GetNbinsX(),bin_lower_y,bin_upper_y)

            Hist_ResidualGamma_Rank[len(Hist_ResidualGamma_Rank)-1].SetBinContent(1,abs(1.-data_rank0_gamma_integral/data_gamma_integral))
            Hist_ResidualGamma_Rank[len(Hist_ResidualGamma_Rank)-1].SetBinError(1,pow(abs(data_rank0_gamma_integral),0.5)/data_gamma_integral)
            Hist_ResidualGamma_Rank[len(Hist_ResidualGamma_Rank)-1].SetBinContent(2,abs(1.-(data_rank0_gamma_integral+data_rank1_gamma_integral)/data_gamma_integral))
            Hist_ResidualGamma_Rank[len(Hist_ResidualGamma_Rank)-1].SetBinError(2,pow(abs(data_rank1_gamma_integral),0.5)/data_gamma_integral)
            Hist_ResidualGamma_Rank[len(Hist_ResidualGamma_Rank)-1].SetBinContent(3,abs(1.-(data_rank0_gamma_integral+data_rank1_gamma_integral+data_rank2_gamma_integral)/data_gamma_integral))
            Hist_ResidualGamma_Rank[len(Hist_ResidualGamma_Rank)-1].SetBinError(3,pow(abs(data_rank2_gamma_integral),0.5)/data_gamma_integral)
            Hist_ResidualGamma_Rank[len(Hist_ResidualGamma_Rank)-1].SetBinContent(4,abs(1.-(data_rank0_gamma_integral+data_rank1_gamma_integral+data_rank2_gamma_integral+data_rank3_gamma_integral)/data_gamma_integral))
            Hist_ResidualGamma_Rank[len(Hist_ResidualGamma_Rank)-1].SetBinError(4,pow(abs(data_rank3_gamma_integral),0.5)/data_gamma_integral)

            Hist_CountGamma_Rank[len(Hist_CountGamma_Rank)-1].SetBinContent(1,data_rank0_gamma_integral)
            Hist_CountGamma_Rank[len(Hist_CountGamma_Rank)-1].SetBinError(1,pow(abs(data_rank0_gamma_integral),0.5))
            Hist_CountGamma_Rank[len(Hist_CountGamma_Rank)-1].SetBinContent(2,data_rank1_gamma_integral)
            Hist_CountGamma_Rank[len(Hist_CountGamma_Rank)-1].SetBinError(2,pow(abs(data_rank1_gamma_integral),0.5))
            Hist_CountGamma_Rank[len(Hist_CountGamma_Rank)-1].SetBinContent(3,data_rank2_gamma_integral)
            Hist_CountGamma_Rank[len(Hist_CountGamma_Rank)-1].SetBinError(3,pow(abs(data_rank2_gamma_integral),0.5))
            Hist_CountGamma_Rank[len(Hist_CountGamma_Rank)-1].SetBinContent(4,data_rank3_gamma_integral)
            Hist_CountGamma_Rank[len(Hist_CountGamma_Rank)-1].SetBinError(4,pow(abs(data_rank3_gamma_integral),0.5))

            Hist_Fit_CountGamma_Rank[len(Hist_Fit_CountGamma_Rank)-1].SetBinContent(1,fit_rank0_gamma_integral)
            Hist_Fit_CountGamma_Rank[len(Hist_Fit_CountGamma_Rank)-1].SetBinError(1,pow(abs(fit_rank0_gamma_integral),0.5))
            Hist_Fit_CountGamma_Rank[len(Hist_Fit_CountGamma_Rank)-1].SetBinContent(2,fit_rank1_gamma_integral)
            Hist_Fit_CountGamma_Rank[len(Hist_Fit_CountGamma_Rank)-1].SetBinError(2,pow(abs(fit_rank1_gamma_integral),0.5))
            Hist_Fit_CountGamma_Rank[len(Hist_Fit_CountGamma_Rank)-1].SetBinContent(3,fit_rank2_gamma_integral)
            Hist_Fit_CountGamma_Rank[len(Hist_Fit_CountGamma_Rank)-1].SetBinError(3,pow(abs(fit_rank2_gamma_integral),0.5))
            Hist_Fit_CountGamma_Rank[len(Hist_Fit_CountGamma_Rank)-1].SetBinContent(4,fit_rank3_gamma_integral)
            Hist_Fit_CountGamma_Rank[len(Hist_Fit_CountGamma_Rank)-1].SetBinError(4,pow(abs(fit_rank3_gamma_integral),0.5))

            Hist_CountHadron3_Rank[len(Hist_CountHadron3_Rank)-1].SetBinContent(1,data_rank0_hadron3_integral)
            Hist_CountHadron3_Rank[len(Hist_CountHadron3_Rank)-1].SetBinError(1,pow(abs(data_rank0_hadron3_integral),0.5))
            Hist_CountHadron3_Rank[len(Hist_CountHadron3_Rank)-1].SetBinContent(2,data_rank1_hadron3_integral)
            Hist_CountHadron3_Rank[len(Hist_CountHadron3_Rank)-1].SetBinError(2,pow(abs(data_rank1_hadron3_integral),0.5))
            Hist_CountHadron3_Rank[len(Hist_CountHadron3_Rank)-1].SetBinContent(3,data_rank2_hadron3_integral)
            Hist_CountHadron3_Rank[len(Hist_CountHadron3_Rank)-1].SetBinError(3,pow(abs(data_rank2_hadron3_integral),0.5))
            Hist_CountHadron3_Rank[len(Hist_CountHadron3_Rank)-1].SetBinContent(4,data_rank3_hadron3_integral)
            Hist_CountHadron3_Rank[len(Hist_CountHadron3_Rank)-1].SetBinError(4,pow(abs(data_rank3_hadron3_integral),0.5))
            Hist_Fit_CountHadron3_Rank[len(Hist_Fit_CountHadron3_Rank)-1].SetBinContent(1,fit_rank0_hadron3_integral)
            Hist_Fit_CountHadron3_Rank[len(Hist_Fit_CountHadron3_Rank)-1].SetBinError(1,pow(abs(fit_rank0_hadron3_integral),0.5))
            Hist_Fit_CountHadron3_Rank[len(Hist_Fit_CountHadron3_Rank)-1].SetBinContent(2,fit_rank1_hadron3_integral)
            Hist_Fit_CountHadron3_Rank[len(Hist_Fit_CountHadron3_Rank)-1].SetBinError(2,pow(abs(fit_rank1_hadron3_integral),0.5))
            Hist_Fit_CountHadron3_Rank[len(Hist_Fit_CountHadron3_Rank)-1].SetBinContent(3,fit_rank2_hadron3_integral)
            Hist_Fit_CountHadron3_Rank[len(Hist_Fit_CountHadron3_Rank)-1].SetBinError(3,pow(abs(fit_rank2_hadron3_integral),0.5))
            Hist_Fit_CountHadron3_Rank[len(Hist_Fit_CountHadron3_Rank)-1].SetBinContent(4,fit_rank3_hadron3_integral)
            Hist_Fit_CountHadron3_Rank[len(Hist_Fit_CountHadron3_Rank)-1].SetBinError(4,pow(abs(fit_rank3_hadron3_integral),0.5))

            Hist_CountHadron1_Rank[len(Hist_CountHadron1_Rank)-1].SetBinContent(1,data_rank0_hadron1_integral)
            Hist_CountHadron1_Rank[len(Hist_CountHadron1_Rank)-1].SetBinError(1,pow(abs(data_rank0_hadron1_integral),0.5))
            Hist_CountHadron1_Rank[len(Hist_CountHadron1_Rank)-1].SetBinContent(2,data_rank1_hadron1_integral)
            Hist_CountHadron1_Rank[len(Hist_CountHadron1_Rank)-1].SetBinError(2,pow(abs(data_rank1_hadron1_integral),0.5))
            Hist_CountHadron1_Rank[len(Hist_CountHadron1_Rank)-1].SetBinContent(3,data_rank2_hadron1_integral)
            Hist_CountHadron1_Rank[len(Hist_CountHadron1_Rank)-1].SetBinError(3,pow(abs(data_rank2_hadron1_integral),0.5))
            Hist_CountHadron1_Rank[len(Hist_CountHadron1_Rank)-1].SetBinContent(4,data_rank3_hadron1_integral)
            Hist_CountHadron1_Rank[len(Hist_CountHadron1_Rank)-1].SetBinError(4,pow(abs(data_rank3_hadron1_integral),0.5))
            Hist_Fit_CountHadron1_Rank[len(Hist_Fit_CountHadron1_Rank)-1].SetBinContent(1,fit_rank0_hadron1_integral)
            Hist_Fit_CountHadron1_Rank[len(Hist_Fit_CountHadron1_Rank)-1].SetBinError(1,pow(abs(fit_rank0_hadron1_integral),0.5))
            Hist_Fit_CountHadron1_Rank[len(Hist_Fit_CountHadron1_Rank)-1].SetBinContent(2,fit_rank1_hadron1_integral)
            Hist_Fit_CountHadron1_Rank[len(Hist_Fit_CountHadron1_Rank)-1].SetBinError(2,pow(abs(fit_rank1_hadron1_integral),0.5))
            Hist_Fit_CountHadron1_Rank[len(Hist_Fit_CountHadron1_Rank)-1].SetBinContent(3,fit_rank2_hadron1_integral)
            Hist_Fit_CountHadron1_Rank[len(Hist_Fit_CountHadron1_Rank)-1].SetBinError(3,pow(abs(fit_rank2_hadron1_integral),0.5))
            Hist_Fit_CountHadron1_Rank[len(Hist_Fit_CountHadron1_Rank)-1].SetBinContent(4,fit_rank3_hadron1_integral)
            Hist_Fit_CountHadron1_Rank[len(Hist_Fit_CountHadron1_Rank)-1].SetBinError(4,pow(abs(fit_rank3_hadron1_integral),0.5))

            Hist_CountHadron2_Rank[len(Hist_CountHadron2_Rank)-1].SetBinContent(1,data_rank0_hadron2_integral)
            Hist_CountHadron2_Rank[len(Hist_CountHadron2_Rank)-1].SetBinError(1,pow(abs(data_rank0_hadron2_integral),0.5))
            Hist_CountHadron2_Rank[len(Hist_CountHadron2_Rank)-1].SetBinContent(2,data_rank1_hadron2_integral)
            Hist_CountHadron2_Rank[len(Hist_CountHadron2_Rank)-1].SetBinError(2,pow(abs(data_rank1_hadron2_integral),0.5))
            Hist_CountHadron2_Rank[len(Hist_CountHadron2_Rank)-1].SetBinContent(3,data_rank2_hadron2_integral)
            Hist_CountHadron2_Rank[len(Hist_CountHadron2_Rank)-1].SetBinError(3,pow(abs(data_rank2_hadron2_integral),0.5))
            Hist_CountHadron2_Rank[len(Hist_CountHadron2_Rank)-1].SetBinContent(4,data_rank3_hadron2_integral)
            Hist_CountHadron2_Rank[len(Hist_CountHadron2_Rank)-1].SetBinError(4,pow(abs(data_rank3_hadron2_integral),0.5))
            Hist_Fit_CountHadron2_Rank[len(Hist_Fit_CountHadron2_Rank)-1].SetBinContent(1,fit_rank0_hadron2_integral)
            Hist_Fit_CountHadron2_Rank[len(Hist_Fit_CountHadron2_Rank)-1].SetBinError(1,pow(abs(fit_rank0_hadron2_integral),0.5))
            Hist_Fit_CountHadron2_Rank[len(Hist_Fit_CountHadron2_Rank)-1].SetBinContent(2,fit_rank1_hadron2_integral)
            Hist_Fit_CountHadron2_Rank[len(Hist_Fit_CountHadron2_Rank)-1].SetBinError(2,pow(abs(fit_rank1_hadron2_integral),0.5))
            Hist_Fit_CountHadron2_Rank[len(Hist_Fit_CountHadron2_Rank)-1].SetBinContent(3,fit_rank2_hadron2_integral)
            Hist_Fit_CountHadron2_Rank[len(Hist_Fit_CountHadron2_Rank)-1].SetBinError(3,pow(abs(fit_rank2_hadron2_integral),0.5))
            Hist_Fit_CountHadron2_Rank[len(Hist_Fit_CountHadron2_Rank)-1].SetBinContent(4,fit_rank3_hadron2_integral)
            Hist_Fit_CountHadron2_Rank[len(Hist_Fit_CountHadron2_Rank)-1].SetBinError(4,pow(abs(fit_rank3_hadron2_integral),0.5))

            Hist_Eigenvalues[len(Hist_Eigenvalues)-1].Add(Hist_Data_Eigenvalues_real_SumE)
            Hist_Eigenvalues[len(Hist_Eigenvalues)-1].GetXaxis().SetRangeUser(0,4)
            Hist_Eigenvector_0[len(Hist_Eigenvector_0)-1].Add(Hist_Data_Eigenvector_0_real_SumE)
            Hist_Eigenvector_1[len(Hist_Eigenvector_1)-1].Add(Hist_Data_Eigenvector_1_real_SumE)
            Hist_InvEigenvector_0[len(Hist_InvEigenvector_0)-1].Add(Hist_Data_InvEigenvector_0_real_SumE)
            Hist_InvEigenvector_1[len(Hist_InvEigenvector_1)-1].Add(Hist_Data_InvEigenvector_1_real_SumE)

    MakeComparisonPlot(Hist_Eigenvalues,legend_S2B,color_S2B,'entry','size','Eigenvalues_%s'%(folder_tag),0.,0.,False,False)
    MakeComparisonPlot(Hist_Eigenvector_0,legend_S2B,color_S2B,'entry','size','Eigenvector_0_%s'%(folder_tag),0.,0.,False,False)
    MakeComparisonPlot(Hist_Eigenvector_1,legend_S2B,color_S2B,'entry','size','Eigenvector_1_%s'%(folder_tag),0.,0.,False,False)
    MakeComparisonPlot(Hist_InvEigenvector_0,legend_S2B,color_S2B,'entry','size','InvEigenvector_0_%s'%(folder_tag),0.,0.,False,False)
    MakeComparisonPlot(Hist_InvEigenvector_1,legend_S2B,color_S2B,'entry','size','InvEigenvector_1_%s'%(folder_tag),0.,0.,False,False)
    MakeComparisonPlot(Hist_ResidualGamma_Rank,legend_S2B,color_S2B,'n ranks','Residual in gamma region','ResidualGamma_Rank_%s'%(folder_tag),0.,0.,False,True)
    ...
    MakeComparisonPlot(Hist_Fit_CountGamma_Rank,legend_S2B,color_S2B,'n ranks','counts in gamma region','CountGamma_Fit_Rank_%s'%(folder_tag),0.,0.,False,False)
    MakeComparisonPlot(Hist_Fit_CountHadron3_Rank,legend_S2B,color_S2B,'n ranks','counts in hadron region 3','CountHadron3_Fit_Rank_%s'%(folder_tag),0.,0.,False,False)
    MakeComparisonPlot(Hist_Fit_CountHadron1_Rank,legend_S2B,color_S2B,'n ranks','counts in hadron region 1','CountHadron1_Fit_Rank_%s'%(folder_tag),0.,0.,False,False)
    MakeComparisonPlot(Hist_Fit_CountHadron2_Rank,legend_S2B,color_S2B,'n ranks','counts in hadron region 2','CountHadron2_Fit_Rank_%s'%(folder_tag),0.,0.,False,False)
    ...
    for source in range(0,len(FilePath_Folder0)):
        ...
        for path in range(1,len(FilePath_Folder0[source])):
            ...
            for e in range(0,len(energy_list)-1):
                ...
                if ErecS_lower_cut>=energy_fine_bin[energy_fine_bin_cut_up]: continue
                GetShowerHistogramsFromFile(FilePath_Folder0[source][path])
                GetRingHistogramsFromFile(FilePath_Folder0[source][path])
                StackShowerHistograms()
                StackRingHistograms()
                NormalizeEnergyHistograms(FilePath_Folder0[source][path])
                StackEnergyHistograms()
        ...
        Hist_Eigenvalue_real_Rank[len(Hist_Eigenvalue_real_Rank)-1].Add(Hist_Data_Eigenvalues_real_SumE)
        Hist_Eigenvector_0 += [ROOT.TH1D("Hist_Eigenvector_0","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_0[len(Hist_Eigenvector_0)-1].Add(Hist_Data_Eigenvector_0_real_SumE)
        Hist_Eigenvector_1 += [ROOT.TH1D("Hist_Eigenvector_1","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_1[len(Hist_Eigenvector_1)-1].Add(Hist_Data_Eigenvector_1_real_SumE)
        Hist_Eigenvector_2 += [ROOT.TH1D("Hist_Eigenvector_2","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_2[len(Hist_Eigenvector_2)-1].Add(Hist_Data_Eigenvector_2_real_SumE)
        Hist_InvEigenvector_0 += [ROOT.TH1D("Hist_InvEigenvector_0","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_0[len(Hist_InvEigenvector_0)-1].Add(Hist_Data_InvEigenvector_0_real_SumE)
        Hist_InvEigenvector_1 += [ROOT.TH1D("Hist_InvEigenvector_1","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_1[len(Hist_InvEigenvector_1)-1].Add(Hist_Data_InvEigenvector_1_real_SumE)
        Hist_InvEigenvector_2 += [ROOT.TH1D("Hist_InvEigenvector_2","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_2[len(Hist_InvEigenvector_2)-1].Add(Hist_Data_InvEigenvector_2_real_SumE)
        legend_S2B += ['ON data']
        ...
        Hist_Eigenvector_2 += [ROOT.TH1D("Hist_Eigenvector_2","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_2[len(Hist_Eigenvector_2)-1].Add(Hist_Dark_Eigenvector_2_real_SumE)
        Hist_InvEigenvector_0 += [ROOT.TH1D("Hist_InvEigenvector_0","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_0[len(Hist_InvEigenvector_0)-1].Add(Hist_Dark_InvEigenvector_0_real_SumE)
        Hist_InvEigenvector_1 += [ROOT.TH1D("Hist_InvEigenvector_1","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_1[len(Hist_InvEigenvector_1)-1].Add(Hist_Dark_InvEigenvector_1_real_SumE)
        Hist_InvEigenvector_2 += [ROOT.TH1D("Hist_InvEigenvector_2","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_2[len(Hist_InvEigenvector_2)-1].Add(Hist_Dark_InvEigenvector_2_real_SumE)
        legend_S2B += ['OFF data']
        ...
        Hist_Eigenvector_2 += [ROOT.TH1D("Hist_Eigenvector_2","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_Eigenvector_2[len(Hist_Eigenvector_2)-1].Add(Hist_Fit_Eigenvector_2_real_SumE)
        Hist_InvEigenvector_0 += [ROOT.TH1D("Hist_InvEigenvector_0","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_0[len(Hist_InvEigenvector_0)-1].Add(Hist_Fit_InvEigenvector_0_real_SumE)
        Hist_InvEigenvector_1 += [ROOT.TH1D("Hist_InvEigenvector_1","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_1[len(Hist_InvEigenvector_1)-1].Add(Hist_Fit_InvEigenvector_1_real_SumE)
        Hist_InvEigenvector_2 += [ROOT.TH1D("Hist_InvEigenvector_2","",N_bins_for_deconv,0,N_bins_for_deconv)]
        Hist_InvEigenvector_2[len(Hist_InvEigenvector_2)-1].Add(Hist_Fit_InvEigenvector_2_real_SumE)
        legend_S2B += ['Fit']
        ...
        MakeComparisonPlot(Hist_Eigenvector_2,legend_S2B,color_S2B,'k','amplitude','ONOFF_Eigenvector_real_2_%s%s_%s_%s'%(source_name,PercentCrab,ONOFF,folder_tag),0.,0.,False,False)
        MakeComparisonPlot(Hist_InvEigenvector_0,legend_S2B,color_S2B,'k','amplitude','ONOFF_InvEigenvector_real_0_%s%s_%s_%s'%(source_name,PercentCrab,ONOFF,folder_tag),0.,0.,False,False)
        MakeComparisonPlot(Hist_InvEigenvector_1,legend_S2B,color_S2B,'k','amplitude','ONOFF_InvEigenvector_real_1_%s%s_%s_%s'%(source_name,PercentCrab,ONOFF,folder_tag),0.,0.,False,False)
        MakeComparisonPlot(Hist_InvEigenvector_2,legend_S2B,color_S2B,'k','amplitude','ONOFF_InvEigenvector_real_2_%s%s_%s_%s'%(source_name,PercentCrab,ONOFF,folder_tag),0.,0.,False,False)
        ...
        Hist_Data_Skymap2_SumE.Rebin2D(n_rebin,n_rebin)
        ...
        Hist_Data_Skymap2_smooth = Smooth2DMap(Hist_Data_Skymap2_SumE,smooth_size,False)
        ...
        Make2DSignificancePlot(Syst_Ring,Hist_Data_Skymap2_SumE,Hist_Ring_Skymap_SumE,Hist_Data_Skymap2_smooth,Hist_Ring_Skymap_smooth,Hist_Skymap_zoomin,Hist_Highlight_Skymap,Hist_Highlight_Bias_Skymap,Hist_Highlight_Skymap_zoomin,'RA','Dec','Skymap_Ring_%s%s_%s_%s'%(source_name,PercentCrab,ONOFF,folder_tag))
...
Hist_Data_Skymap2 = ROOT.TH2D("Hist_Data_Skymap2","",150,source_ra-3,source_ra+3,150,source_dec-3,source_dec+3)
...
Hist_Data_Skymap2_SumE = ROOT.TH2D("Hist_Data_Skymap2_SumE","",150,source_ra-3,source_ra+3,150,source_dec-3,source_dec+3)
